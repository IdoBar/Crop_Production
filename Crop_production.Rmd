...
```{r chickpea-prod2, fig.cap="Chickpea production data 1989-2022<br>Data source: [Agricultural commodities and trade data](https://www.awe.gov.au/abares/research-topics/agricultural-outlook/data#australian-crop-report-data), Australian Bureau of Agricultural and Resource Economics and Sciences (ABARES)"}
...
```{r chickpea-prod, fig.cap="Chickpea production and price data 1989-2022<br>Data source: [Agricultural commodities and trade data](https://www.awe.gov.au/abares/research-topics/agricultural-outlook/data#australian-crop-report-data), Australian Bureau of Agricultural and Resource Economics and Sciences (ABARES)"}
# multiplier for secondary y-axis
coeff <- 1
# plot stacked bar graph
